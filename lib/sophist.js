...
Sophist.prototype.createReadStream = function(options) {
  var self = this;	
  return new ReadStream(options, this, function(opts) {
  	return self.db.iterator(opts);
  })	
};

Sophist.prototype.createKeyStream = function(options) {
  return this.createReadStream(extend(options, {key: true, value: false}));
};

Sophist.prototype.createValueStream = function(options) {
  return this.createReadStream(extend(options, {key: false, value: true}));
};
